...
module "EXAMPLE_ec2_keypair" {
  ...
  #compliance_id     = prismacloud_compliance_standard_requirement_section.CSRS_EXAMPLE_EC2.csrs_id
  ...
  #section_id = prismacloud_compliance_standard_requirement_section.CSRS_EXAMPLE_EC2.section_id
  #standard_name = prismacloud_compliance_standard.CS_PANW.name
  #section_description = prismacloud_compliance_standard_requirement_section.CSRS_EXAMPLE_EC2.description
  #standard_description = prismacloud_compliance_standard.CS_PANW.description
  #section_id        = prismacloud_compliance_standard_requirement_section.CSRS_EXAMPLE_EC2.csrs_id
  #requirement_id    = prismacloud_compliance_standard_requirement.CSR_EXAMPLE.csr_id
